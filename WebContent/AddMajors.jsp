...
<body class="">
	...
	<div class="content">
		...
		<div class="header">
			...
			<h1 class="page-title">Add Major</h1>
		</div>

		<ul class="breadcrumb">
			<li><a href="index.jsp">Home</a> <span class="divider">/</span></li>
			<li><a href="Majors.jsp">Majors</a> <span class="divider">/</span></li>
			<li class="active">Add Major</li>
		</ul>
				...
				<div class="well">
					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane active in" id="home">
							<form action="/BaiduFace/AddMajors" id="tab" method="post">
								<label>Major Name</label> <input name="name" type="text" value=""
									class="input-xlarge"> <label>Department</label> <select
									name="DepartmentChosen" id="DropDownTimezone"
									class="input-xlarge">
