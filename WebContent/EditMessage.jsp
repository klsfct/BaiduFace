...
<body>
	...
	<div class="content">
		...
		<ul class="breadcrumb">
			...
			<li><a href="#">Edit message</a> <span class="divider">/</span></li>
				...
				<div class="well">
					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane active in" id="home">
							<form action="/BaiduFace/MotifyMessage" id="tab" method="post">
								    <label>Student name</label> 
								    <input type="text" readOnly="true" value=<%=request.getParameter("name")%> class="input-xlarge" name="name"> 
									<label>Course name</label> 
								    <input type="text" readOnly="true" value=<%=request.getParameter("course")%> class="input-xlarge" name="name">
									<label>The state of sign in</label> 
									<select name="flag1">
									<option value="1">出勤</option>
									<option value="0">缺勤</option>
									<option value="2">迟到</option>
								    </select> 
								    <label>The state of sign back</label> 
									<select name="flag2">
									<option value="1">出勤</option>
									<option value="0">缺勤</option>
