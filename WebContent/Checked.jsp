						...
						<tbody>
							<c:forEach var="p" items="${alist}" varStatus="status">
								<tr>
									...
									<td>${p.time2}</td>
									<td>${p.flag2}</td>
									<td><a href="/BaiduFace/EditMessage.jsp?name=${p.name}&course='${p.coursename}'"><i class="icon-pencil"></i></a> <a
								...
								<div class="modal small hide fade" id="myModal" tabindex="-1"
									...
									<div class="modal-footer">
											...
											<button class="btn" data-dismiss="modal" onClick="window.open('/BaiduFace/DeleteMessage?name=${p.name}&coursename=${p.coursename}')">Delete</button>
									</div>
								</div>
